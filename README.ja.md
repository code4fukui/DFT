...
- [DFT デモ](https://code4fukui.github.io/DFT/)
...
- Core i7-6700 Windows 10 NVIDIA RTX 3060Ti, 0.007705秒 (fast-math)

### 132300サンプル 3秒 

- M1 Macbook Pro, C言語 (6スレッド), 22.464575秒
- Core i7-6700 Windows 10 NVIDIA RTX 3060Ti, 0.690248秒
- Core i7-6700 Windows 10 NVIDIA RTX 3060Ti, 0.044306秒 (fast-math)

### 441000サンプル 10秒

- M1 Macbook Pro, C言語 (6スレッド), 266.189622秒
- Core i7-6700 Windows 10 NVIDIA RTX 3060Ti, 9.357527秒
- Core i7-6700 Windows 10 NVIDIA RTX 3060Ti, 0.387023秒 (fast-math)

### 6028176サンプル全体

- Core i7-6700 Windows 10 NVIDIA RTX 3060Ti, 63.493813秒 (fast-math)